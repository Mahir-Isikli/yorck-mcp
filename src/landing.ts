...
export const MOVIE_AGENT_ICON_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" role="img" aria-label="Movie agent icon">
  <rect x="4" y="4" width="56" height="56" rx="14" fill="#fcef17" stroke="#1a1a1a" stroke-width="3"/>
  <circle cx="23" cy="22" r="7.5" fill="#1a1a1a"/>
  <circle cx="39" cy="22" r="7.5" fill="#1a1a1a"/>
  <circle cx="23" cy="22" r="2.2" fill="#fcef17"/>
  <circle cx="39" cy="22" r="2.2" fill="#fcef17"/>
  <rect x="15" y="31" width="32" height="18" rx="5" fill="#1a1a1a"/>
  <path d="M46 35.5 57 29v24l-11-6.5z" fill="#1a1a1a"/>
  <path d="M25 35.5 36 40l-11 4.5z" fill="#fcef17"/>
  <path d="M22 54h20" stroke="#1a1a1a" stroke-width="3" stroke-linecap="round"/>
</svg>`;
...
<body>
  <header class="topbar">
    <nav class="page nav" aria-label="main navigation">
      <a class="brand" href="/" aria-label="Yorck Movie Agent home">
        <span class="mark movie-mark" aria-hidden="true">${MOVIE_AGENT_ICON_SVG}</span>
  ...
  <main class="page">
    ...
    <section class="footer">
      <span class="mark movie-mark" aria-hidden="true">${MOVIE_AGENT_ICON_SVG}</span>
      <p>Made with love in Berlin by Mahir Isikli.</p>
      <div class="footer-links">
        <a href="https://www.linkedin.com/in/mahir-isikli/" target="_blank" rel="noopener noreferrer">LinkedIn</a>
        <a href="https://x.com/slobkebap" target="_blank" rel="noopener noreferrer">X</a>
        <a href="https://github.com/Mahir-Isikli/yorck-mcp" target="_blank" rel="noopener noreferrer">GitHub</a>
      </div>
      <p class="legal-note">Unofficial independent project. Not affiliated with, endorsed by, or sponsored by Yorck Kinogruppe. “Yorck” and related names, marks, logos, and trademarks belong to their respective owners. The name is used only to identify the compatible cinema service.</p>
